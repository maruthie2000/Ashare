...
public class UserController {
	...
	@PostMapping("/login")
	public ResponseEntity<ResponseStructure<String>> userLogin(@RequestParam String emailOrPhone,
			@RequestParam String password, HttpSession httpSession) {
		System.out.println(emailOrPhone);
		return userService.userLogin(emailOrPhone, password, httpSession);
	}
	...
	public ResponseEntity<ResponseStructure<String>> verifyUser(@RequestBody User user) {
